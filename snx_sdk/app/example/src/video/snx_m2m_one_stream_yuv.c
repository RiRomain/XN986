...
/*----------------- Stream 1 M2M stream --------------------------------------*/
#define FORMAT			V4L2_PIX_FMT_SNX420	// V4L2_PIX_FMT_H264 or V4L2_PIX_FMT_MJPEG or V4L2_PIX_FMT_SNX420
											// Video Encode Format
...
#define YUV_FRAME_RATE	5				// Video Encoded Frame Rate
#define IMG_DEV_NAME	"/dev/video0"		// ISP Device Node
#define CAP_DEV_NAME	"/dev/video1"		// Video Codec Device Node for M2M
#define FRAME_NUM		1				// Video Encoded Frame Number
#define SCALE			1				// 1: 1, 2: 1/2, 4: 1/4 scaling down
#define FILENAME		"/tmp/video1.yuv"	// Video Encoded File Path
//#define FILENAME		"/tmp/video1.bmp"	// Video Encoded File Path

#define BIT_RATE		512000				// Bitrate control for H264 ONLY
...
int main(int argc, char **argv)
{
	...
	stream1->yuv_frame = YUV_FRAME_RATE;

	/*--------------------------------------------------------
		Start 
	---------------------------------------------------------*/
	ret = pthread_create(&stream1->stream_thread, NULL, (void *)snx_m2m_yuv_flow, stream1);
//	ret = pthread_create(&stream1->stream_thread, NULL, (void *)snx_isp_yuv_flow, stream1);
//	ret = pthread_create(&stream1->stream_thread, NULL, (void *)snx_isp_bmp_flow, stream1);
