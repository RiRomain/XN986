...
struct v4l2_video_device{
	...
	int height;
	int rate;
	enum v4l2_memory iotype;
	int nbuffers;
	int frame_sz;
	snx_frame_ctx_t frames;
	int type;
...
struct encode_context{
	char name[32];
	int fd;
	int output_width, output_height,cap_width, cap_height,  ratio, codec, qp;
	int bitrate,gop;
	int set_qp_flag;
	int set_gop_flag;
	int frame_size;
	int index;
	enum v4l2_memory iotype[3];

	struct v4l2_format output_fmt;
	struct v4l2_format capture_fmt;

	struct v4l2_requestbuffers req[3];
	snx_frame_ctx_t frames[3];
	int nbuffers[3][2];	
};
...
//    struct v4l2_video_device *dev;
//    struct encode_context *enc_ctx;
//    int h264_iframe_flag;
